...
const validatorNewCreate = [
    ...
    check('imagen').notEmpty().withMessage('El campo imagen es obligatorio').isString().withMessage('El campo imagen debe ser un Base 64'),
...
const validatorNewUpdate = [
    ...
    check('imagen').optional().isString().withMessage('El campo imagen debe ser un Base 64'),
    check('activo').optional().isBoolean().withMessage('El campo activo debe ser un booleano'),
];
